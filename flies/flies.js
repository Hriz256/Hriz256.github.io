...
<link rel="stylesheet" href="http://admin.webwidgets.ru/monster/css/style.css">
    ...
    wrapperSvg.style.zIndex = '100000';
    ...
    swatterStyles.style.zIndex = '100000';
    ...
    swatterContainerStyles.style.zIndex = '100000';
    ...
    closeSvgImgStyles.style.zIndex = '100000';
    ...
    function onMove(e) {
        if (!closeCount && !overTheCloseButton) {
            TweenMax.set(".swatter-container", {
                x: e.pageX,
                y: e.pageY - window.pageYOffset,
                autoAlpha: 1
...
// swarm
    ...
    swatterButton.style.zIndex = '100000';
    ...
    setInterval(() => {
        ...
        buttonClose.style.left = `${document.documentElement.clientWidth - 137 + buttonWidth / 1.5}px`
    ...
    window.addEventListener(touchMove, (e) => {
        ...
        if (!isRemove) {
            ...
            if (e.clientX > buttonX && e.clientX < buttonX + buttonWidth && e.clientY > buttonY && e.clientY < buttonY + buttonHeight) {
                ...
                buttonClose.style.opacity = '0.5'
                swatter.style.visibility = 'hidden';
                overTheCloseButton = true;
            } else {
                buttonClose.style.opacity = '1';
                swatter.style.visibility = 'visible';
                overTheCloseButton = false;
            }
        }
    })
}